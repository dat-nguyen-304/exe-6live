            ...
            <div className="grid gap-6 mb-6 md:grid-cols-4">
                ...
                <div className="md:col-span-3 grid gap-6 mb-6 md:grid-cols-3">
                            ...
                            {locats.map(
                                (locat, index) =>
                                    locat.value !== 'all' && (
                                        <div
                                            key={locat.value}
                                            onClick={() => addLocation(locat.value, index - 1)}
                                            className={`border-2 px-2 py-1 rounded-lg cursor-pointer
                    ...
                    {locats.map(
                        (locat, index) =>
                            locat.value !== 'all' &&
                            locations.includes(locat.value) && (
                                <div key={locat.value}>
                                    <label
                                        htmlFor={`address-${locat.value}`}
                                    ...
                                    <input
                                        type="text"
                                        id={`address-${locat.value}`}
                                        value={addresses[index - 1]}
                                        onChange={e => addAddress(e, index - 1)}
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder={`100 Hai Bà Trưng - ${locat.label}`}
                                        required
                                    />
                                </div>
                            )
