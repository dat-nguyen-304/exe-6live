                    ...
                    <div>
                        ...
                        >
                            {locations.map(l => {
                                return (
                                    l.value !== 'all' && (
                                        <option key={l.value} selected={l.value === location} value={l.value}>
                                            {l.label}
                                        </option>
                                    )
                                );
                    ...
                    <div>
                        ...
                        >
                            {genders.map(g => {
                                return (
                                    g.value !== 'all' && (
                                        <option key={g.value} selected={g.value === gender} value={g.value}>
                                            {g.label}
                                        </option>
                                    )
                                );
                    ...
                    <div>
                        <label className="relative inline-flex items-center mb-4 cursor-pointer">
                            <input
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => toggleWorkStatus(e)}
                            />
